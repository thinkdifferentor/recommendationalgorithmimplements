...
class SamplerFactory(object):
    @classmethod
    def generate_sampler(cls, sampler_name, interactions,n_negatives=None, batch_size=None, n_workers=5,**kwargs):
        """
        Generate a sampler
        :param sampler_name:
        :param interactions:
        ...
        """
        try:
            spl = _SUPPORTED_SAMPLERS[sampler_name](sampler_name, interactions,n_negatives, batch_size, n_workers, **kwargs)
            return spl
        except KeyError:
