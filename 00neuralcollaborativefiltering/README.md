...
```
python NeuMF.py --dataset ml-1m --epochs 20 --batch_size 256 --num_factors 8 --layers [64,32,16,8] --num_neg 4 --lr 0.001 --learner adam --verbose 1 --out 1 --mf_pretrain Pretrain/ml-1m_GMF_8_2022-04-22_22:26:07.h5 --mlp_pretrain Pretrain/ml-1m_MLP_[64,32,16,8]_2022-04-22_22:28:53.h5
```
...
pip install theano==0.8.0  -i http://pypi.tuna.tsinghua.edu.cn/simple/ --trusted-host pypi.tuna.tsinghua.edu.cn