...
def citeulike(tag_occurence_thres=10):
    # Get the user_dict for every user preference (library).
    ...
    # Get the number of features which correlated articles are bigger than the tag_occurence_thres.
    n_features = 0
    ...
    # Get the item-features interaction matrix. The every column is a specific feature correlate to articles.
